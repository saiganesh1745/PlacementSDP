          ...
          {Array.isArray(jobseekers) && jobseekers.length > 0 ? (
            jobseekers.map((jobseeker, index) => (
              <tr key={index}>
                ...
                <td>
                  <button onClick={() => viewJobSeeker(jobseeker.email)} className='button2'>View</button>&nbsp;
                  <button onClick={() => deleteJobSeeker(jobseeker.email)} className='button1'>Delete</button>
                </td>
              </tr>
            ))
          ) : (
