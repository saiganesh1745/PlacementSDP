...
<div className="img4">
  <h3 className="title-style"><u>Post a New Job</u></h3>
  {message ? (
    <h4 className={`message-style ${error ? 'error-style' : 'success-style'}`}>
      {message}
    </h4>
  ) : (
    <h4 className="message-style error-style">{error}</h4>
  )}
