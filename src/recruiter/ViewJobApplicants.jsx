...
export default function ViewJobApplicants() {
  ...
  return (
    <div className="students-table" align="center">
            ...
            <tbody>
                ...
                <td>
                  {applicant.jobStatus}
                            ...
                            <td>
                              <button className='button3' onClick={() => handleStatusChange(applicant.applicantId,"SELECTED")}>SELECTED</button>
                              <button className='button1' onClick={() => handleStatusChange(applicant.applicantId,"REJECTED")}>REJECTED</button>
                            </td>
                        </tr>
                    ))
                ) : (
